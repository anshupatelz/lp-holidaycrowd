        ...
        <section className="py-10 md:py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12">
                    {/* Stat 1 */}
                    <div
                        className="text-center p-2 md:p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-gray-50/50 to-white">
                        <div className="text-3xl md:text-5xl font-light text-primary mb-2 md:mb-3">25,000+</div>
                    ...
                    <div
                        className="text-center p-2 md:p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-gray-50/50 to-white">
                        <div className="text-3xl md:text-5xl font-light text-primary mb-2 md:mb-3">4.8/5</div>
                    ...
                    <div
                        className="text-center p-2 md:p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-gray-50/50 to-white">
                        <div className="text-3xl md:text-5xl font-light text-primary mb-2 md:mb-3">500+</div>
                    ...
                    <div
                        className="text-center p-2 md:p-6 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-gray-50/50 to-white">
                        <div className="text-3xl md:text-5xl font-light text-primary mb-2 md:mb-3">15+</div>
